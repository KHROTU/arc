<p align="center"><img src="https://raw.githubusercontent.com/KHROTU/arc/HEAD/packages/arc/assets/arc-logo-mono-text.png" alt="Arc" /></p>
...
```bash
code --install-extension packages/arc/arc-code-0.4.5.vsix
```
